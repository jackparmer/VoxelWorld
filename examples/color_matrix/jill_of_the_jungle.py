...
world = Volume(voxel_matrix, theme='Mint', resolution=10, zoom=2.0, show_light_source=False, dark_bg=True, color_matrix=color_matrix)
...
def create_rotating_frames(world, steps=36):
    ...
    for i in range(steps):
        ...
        image = Volume(rotated_voxel_matrix, theme='Mint', resolution=10, viewing_angle=(45, 35), zoom=2.0, show_light_source=False, dark_bg=True, color_matrix=rotated_color_matrix).render()
        frames.append(image)
    return frames
